  ...
  return (
    <div className="space-y-1 pt-3 lg:pt-0">
      ...
      {recentTransactions.map((transaction) => {
        return (
          <div className=" divide-y-4 divide-color_light" key={transaction.id}>
