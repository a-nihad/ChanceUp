  ...
  return (
    <>
      <div className="space-y-1 rounded-lg">
        <header className="sticky top-16 grid grid-cols-[40px_1.8fr_1fr_1fr_1fr_28px] rounded-t-lg bg-color_primary  px-4 py-2 text-center text-sm font-semibold text-color_white md:grid-cols-[40px_1.8fr_1fr_1fr_1fr_1fr_1fr_28px] lg:grid-cols-[40px_1.8fr_1fr_1fr_1fr_1fr_1fr_1fr_28px]">
          <h1></h1>
