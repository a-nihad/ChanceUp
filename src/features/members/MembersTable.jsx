  ...
  return (
    <>
      <div className="space-y-1 rounded-lg border">
        <header className="sticky top-16 hidden grid-cols-[45px_2fr_1fr_0.7fr_28px] rounded-t-lg bg-color_primary px-4 py-2 text-sm font-semibold text-color_white sm:grid md:grid-cols-[45px_1.5fr_1.8fr_1fr_1.2fr_28px] lg:grid-cols-[45px_1.5fr_1.8fr_1.2fr_1.2fr_1.8fr_28px] ">
          <div></div>
